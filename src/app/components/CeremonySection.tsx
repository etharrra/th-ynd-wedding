        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-y-8">
                    {/* Date */}
                    <motion.div
                        className="md:col-span-3 flex items-start md:justify-start"
                        {...riseUpAnimation}
                    >
                        <span
                            style={{
                    ...
                    <motion.div className="md:col-span-9" {...riseUpAnimation}>
                        <p
                            className="mb-1"
                            style={{
                                fontFamily: "Marcellus, serif",
                    ...
                    <div
                        className="md:col-span-12 border-t"
                        style={{ borderColor: "#C9C1B5" }}
                    ></div>
                    ...
                    <motion.div className="md:col-span-9" {...riseUpAnimation}>
                        ...
                        >
                            Shwe Phone Shein Road, Car Gyi Gate Bus Stop,
                            Shwepyithar, Yangon
                        </p>
                    </motion.div>
                    <div
                    ...
                    <motion.div className="md:col-span-9" {...riseUpAnimation}>
                        ...
                        >
                            You can take YBS 65 and 42 buses; please get off at
                            the "Car Gyi Gate" bus stop.
                        </p>
                    </motion.div>
                </div>
            </div>
